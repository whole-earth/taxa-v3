...
function initCellRenderer() {
  return new Promise((resolve) => {
    ...
    // rgbeLoader.load("https://cdn.jsdelivr.net/gh/whole-earth/taxa@master/assets/cell/environments/aloe.hdr", function (texture) { // PATHCHANGE
    ...
    const easyGlass = new THREE.MeshPhysicalMaterial({
      roughness: 0.4,
      transmission: 0.3,
      thickness: 2
    });
    ...
    const loadPromises = [
      ...
      new CellComponent("ribbons.glb", grayPurple, { z: -0.5 }, true),
...
function initHumanRenderer() {
  ...
  const materialMap = new THREE.TextureLoader().load("https://cdn.jsdelivr.net/gh/whole-earth/taxa@master/assets/human/blue.jpg"); // PATHCHANGE
  ...
  function modelInit() {
    ...
    // loader.load("https://cdn.jsdelivr.net/gh/whole-earth/taxa@master/assets/human/model.glb", function(gltf) {
